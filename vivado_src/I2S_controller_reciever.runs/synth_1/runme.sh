...
HD_PWD='F:/yadro_i2s_reciever/I2S_controller_reciever/I2S_controller_reciever.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s.tcl
